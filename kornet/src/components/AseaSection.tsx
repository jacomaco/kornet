      ...
      <div className="asea-container">
        <div className="asea-content">
          ...
          <p className="asea-text">
            Som en naturlig övergång till min ASEA-verksamhet har jag djupgående kunskap kring och användning av produkter med banbrytande redoxteknologi. Denna teknologi hjälper till att optimera cellernas naturliga återhämtning och reparation inifrån och ut.
          </p>
          <p className="asea-text">
