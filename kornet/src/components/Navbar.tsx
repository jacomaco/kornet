      ...
      <div className="navbar-container">
        <a href="#home" className={`navbar-logo ${isOpen ? 'hidden-on-mobile' : ''}`} onClick={() => setIsOpen(false)}>
          ...
          <div className="navbar-logo-text-group">
            <span className="navbar-logo-title">Kornets Hälso Spa</span>
            <span className="navbar-logo-subtitle">av Sofia Knuts Johansson</span>
          </div>
        </a>
        ...
        <ul className={`navbar-links ${isOpen ? 'open' : ''}`}>
          ...
          <li><a href="#asea" className="nav-link" onClick={() => setIsOpen(false)}>Cellulär intelligens</a></li>
